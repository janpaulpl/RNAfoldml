...
val is_simple_pknot : int -> int array -> int -> int -> bool
(** [is_simple_pknot str pairs cut1 cut2] is [true] if and only if all
    of the matchings in [pairs] along with (j_0,j_0') = (cut1, cut2)
